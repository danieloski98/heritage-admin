                ...
                <ModalBody className='pt-8'>
                    ...
                    <div className="mt-4 flex">
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <Input name="role" value={formik.values.role} onChange={formik.handleChange} onBlur={formik.handleBlur} bgColor="#327A7C15" fontSize="xs" className='mt-2 font-Inter_Regular' />
                        </div>
                    </div>
