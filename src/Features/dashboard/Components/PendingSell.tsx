...
export default function PendingSell({transactions, setOpenModal, search, sort}: {transactions: Array<ITransaction>, setOpenModal: Function, search: string, sort: number}) {
