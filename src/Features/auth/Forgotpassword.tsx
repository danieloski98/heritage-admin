        ...
        <div className='w-full h-screen overflow-hidden flex'>
            ...
            <div className="flex-1 bg-gray-200 flex flex-col items-center justify-center text-left">
                <div className="flex flex-col">
                    <h3 className='font-Inter_Bold text-2xl text-black'>Forgot Password</h3>
                    <p className='font-Inter_Regular text-gray-500 text-xs mt-2'>We’ll send you a link to reset your password via email</p>

                    <div className="flex flex-col mt-8">
                        <p className='font-Inter_Medium text-black text-sm '>Email Address</p>
                        <div className="w-80">
                            <Input bgColor="#327A7C15" fontSize="xs" className="font-Inter_Regular" />
                        </div>
                    </div>

                    <button onClick={nav} className="text-sm text-white bg-btnBlue w-80 mt-2 h-10 rounded-md">
                        {!loading && <p>Submit</p>}
